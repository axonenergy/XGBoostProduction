...
name_adder = 'revisedFeats1OldGrid'                                                        # Additional Identifier For The Run
...
if iso == 'MISO':
    ...
    tier2_hypergrid_name = 'Gridsearch_Tier2__Backtest_Exps_2020_02_24_BACKTEST_DATA_DICT_MASTER_PJM_EXP20__PJM_1048034_DART_Tier2Target'
    feat_dict = {'SPR_EAD': 2, 'DA_RT': 4, 'FLOAD': 8, 'FTEMP': 32,'OUTAGE': 6}  # Number Of Top Features To Use If Reading From Dict
    gridsearch_feat_dict=feat_dict
elif iso == 'ISONE':
