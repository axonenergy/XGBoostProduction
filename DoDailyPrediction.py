...
for row in trade_handler_df.index:
    ...
    if do_postprocessing:
        ...
        writer = pd.ExcelWriter(upload_directory + predict_date_str_mm_dd_yyyy + '_UPLOAD_FILES_ALL_' + model_type+'_'+ name_adder + '.xlsx', engine='openpyxl',datetime_format='mm/dd/yy')
